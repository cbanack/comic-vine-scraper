...
class ConfigForm(CVForm):
   ...
   def __init__(self, owner):
      ...
      ConfigForm.__STORYARC_CB = i18n.get("ConfigFormStoryArcCB")
   ...
   def __build_detailstab(self):
      ...
      self.__update_checklist.Items.Add(ConfigForm.__STORYARC_CB)
   ...
   def __get_configuration(self):
      ...
      config.update_storyarc_b = is_checked(ConfigForm.__STORYARC_CB)
   ...
   def __set_configuration(self, config):
      ...
      set_checked(ConfigForm.__STORYARC_CB, config.update_storyarc_b)
