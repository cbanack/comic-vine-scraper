...
__other_publishers = frozenset([
   ...
   "Prion Books",
   "Prize",
   "Producciones HM (Hernández-Medina)",
   "Progressive",
   "Promotora K",
   ...
   "The 3-D Zone",
   "The Comic Times, Inc.",
   "The Fellowship of the Reconciliation",
   ...
   "Wizmania - Wizard Brazil: Panini Comics",
   "Wonder Comix",
   "Work Horse Comics",
   "XL Creations",
